...
BERT_DIR=/home/s2110418/Master/Semantic_parsing/SimSemRoberta_logical_focus_topv2/outputs/SimSemRoBerta_weather_500spis_10_epochs
...
for c in 0 1 2 3 4
do 
    OUTPUT_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_topv2_with_grammars/outputs/trainer_SimSemRoBerta_10_epochs_weather_500spis_seed_$c
    mkdir -p ${OUTPUT_DIR}
