...
BERT_DIR=/home/s2110418/Master/Semantic_parsing/SimSemRoberta_logical_focus_topv2/outputs/SimSemRoBerta_weather_25spis_50_epochs
...
for c in 0 1 2 3 4
do 
    OUTPUT_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_topv2_with_grammars/outputs/trainer_SimSemRoBerta_50_epochs_weather_25spis_seed_$c
    mkdir -p ${OUTPUT_DIR}
