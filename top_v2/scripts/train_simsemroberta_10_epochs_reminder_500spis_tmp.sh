...
for c in 4 3
do 
    OUTPUT_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_topv2_with_grammars/outputs/trainer_SimSemRoBerta_10_epochs_reminder_500spis_tmp_seed_$c
    mkdir -p ${OUTPUT_DIR}
