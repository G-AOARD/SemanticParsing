...
for c in 0 1 2 3 4
do 
    OUTPUT_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_topv2_with_grammars/outputs/trainer_SimSemRoBerta_50_epochs_reminder_25spis_seed_$c
    mkdir -p ${OUTPUT_DIR}
