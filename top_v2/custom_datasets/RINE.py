...
def run_dataset():
    ...
    json_path = "/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_with_grammars/data/top/mrc-ner.train"
    label2id_path = "/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_with_grammars/data/top/label2id.json"
    grammar_path = "/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_with_grammars/data/top/extracted_grammar.json"

    tokenizer = AutoTokenizer.from_pretrained(bert_path)
    dataset = RINEDataset(json_path=json_path, label2id_path=label2id_path, grammar_path=grammar_path, tokenizer=tokenizer)
