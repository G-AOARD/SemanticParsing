...
DATA_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_with_grammars/data/top
...
do 
    ...
    OUTPUT_DIR=/home/s2110418/Master/Semantic_parsing/IDSL-semparser/semparser_finetuning_hyperparams_v2_with_grammars/outputs/top/trainer_baseline_with_grammars_seed_$c
    mkdir -p ${OUTPUT_DIR}
    mkdir -p ${OUTPUT_DIR}/dev_logs
    mkdir -p ${OUTPUT_DIR}/test_logs

    CUDA_VISIBLE_DEVICES=0 python ${REPO_PATH}/trainers/trainer_semparser_baseline.py \
    --gpus="1" \
